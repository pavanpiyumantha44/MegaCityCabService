...
<form id="newStaffForm">
    ...
    <div class="mt-5">
        <div class="border-bottom pb-4">
            <h2 class="h5 fw-semibold text-dark">Staff Member Information</h2>
            <p class="mt-1 text-muted small">Add a new staff member to the system. Make sure to enter all the necessary details!</p>
            ...
            <div class="mt-4 row g-3">
                ...
                <!-- Job Title -->
                <div class="col-md-6">
                    <label for="job_title" class="form-label fw-medium">Gender</label>
  ...
  $(document).ready(function() {
    ...
    $("form").on("submit", function(e) {
      ...
      if(isValid){
          $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/admin?action=staff/add",
            data: $(this).serialize(),
